...
1. All your files will be compiled on Ubuntu 20.04 LTS using gcc, using the options 
...
8. In the following examples, the main.c files are shown as examples. You can use them to test your 
